...
***But that was not it***. Once I solved that problem, I was faced with another one yet: rendering the MDX. Since I'm essentially retrieving the values from the NetlifyCMS input/widget components and feeding them as props to `<BlogPreviewTemplate/>`, 
