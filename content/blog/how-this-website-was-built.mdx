...
---
In 2020, any reasonably motivated individual could, with a  little bit of initiative, set up a nice looking, performant website in no time, thanks to the [rise of the no-code movement](https://medium.com/@rrhoover/the-rise-of-no-code-e733d7c0944d) and with it, the proliferation of tools like **Wix** and **Squarespace**. These tools abstract away all the laborious HTML/CSS/JS work which power each and every website under the hood, and promises a hassle-free web development experience, allowing users to set up modern-looking websites in mere minutes. 
