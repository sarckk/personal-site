...
---
In 2020, any reasonably motivated individual could, with a  little bit of initiative, set up for themselves a nice looking, performant website very quickly, thanks to the [rise of the no-code movement](https://medium.com/@rrhoover/the-rise-of-no-code-e733d7c0944d) and with it, the proliferation of tools which allow anyone to make websites without coding. Solutions like **Wix** and **Squarespace** abstract away all the laborious HTML/CSS/JS work which power each and every website under the hood, and promises a hassle-free web development experience, allowing users to set up modern-looking websites in mere minutes. 
...
First off, if anyone reading this wants to give Gatsby a shot, you should probably consult Gatsby's [tutorial](https://www.gatsbyjs.org/tutorial/) first, and go through the whole thing. It's very well structured so completing the tutorial should give you a rough overview of the core ideas underpinning Gatsby — enough to get you started (though ideally a working knowledge of JS should precede this step). This section is not meant as an introduction to Gatsby (or React for that matter), but rather aims to give a general overview of how this site (a Gatsby app) is structured. You can check also out the source code for the website [here](https://github.com/sarckk/personal-site).
...
That being said, there's still issues with the website I've yet to fix, like that one weird Flash of Invisible Text (FOIT) issue that I encounter occasionally only in production. Maybe I'll get around to fixing them one day. Maybe I won't. We'll see.
